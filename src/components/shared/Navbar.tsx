    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-[#e0dfdc] shadow-sm">
      <div className="max-w-5xl mx-auto px-4 flex items-center h-14 gap-2">
        ...
        <nav className="flex items-center ml-auto">
          ...
          {/* Separador */}
          <div className="w-px h-8 bg-[#e0dfdc] mx-1 dark:bg-[#38434f]" />

          {/* Botón Dark Mode */}
          <button
            onClick={toggleDarkMode}
            className={`flex flex-col items-center px-3 py-1 text-xs transition-colors min-w-[64px] h-14 justify-center ${
              isDarkMode ? 'text-yellow-400 hover:text-yellow-300' : 'text-[#00000099] hover:text-black'
            }`}
          ...
          >
            ...
            <span className="hidden md:block mt-0.5">{isDarkMode ? 'Claro' : 'Oscuro'}</span>
          </button>
